...
export const ObservationTaskCard: React.FC<ObservationTaskCardProps> = ({
  task,
  onComplete,
  onBypass,
  onLogActivity,
  ...
  const handleQuickComplete = () => {
    const quickData = {
      observationFocus: task.details.focus || "general",
      notes: `Quick observation: ${task.taskName}`,
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground pl-6">
            {task.details.focus || "General health check"}
          </p>
        </div>
        ...
        {showQuickActions && (
          <div className="flex flex-col sm:flex-row gap-2 pt-2">
            ...
            >
              ...
              {task.plantCount && task.plantCount > 1
                ? `Observe ${task.plantCount} plants`
                : `Quick: ${task.details.focus || "Observe"}`}
            </Button>
